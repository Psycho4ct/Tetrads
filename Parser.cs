...
namespace laba5
{
    internal class Parser
    {
        ...
        public void tetrada(DataGridView dataGridView3)
        {
            ...
            dataGridView3.Columns.Add("Op", "op");
            dataGridView3.Columns.Add("Arg1", "arg1");
            dataGridView3.Columns.Add("Arg2", "arg2");
            dataGridView3.Columns.Add("Result", "result");

            foreach (var str in table)
            {
                dataGridView3.Rows.Add(str.num, str.op, str.arg1, str.arg2, str.result);
            }
